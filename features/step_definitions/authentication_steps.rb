...
When /I should( not)?see signed in items/ do |negate|
  ...
  negate ? Then %Q(I should see the link "Sign In" in the "header" section) : Then %Q(I should not see the link "Sign In" in the "header" section)
  negate ? Then %Q(I should see the link "Join" in the "header" section) : Then %Q(I should not see the link "Join" in the "header" section)
  negate ? Then %Q(I should see "Get personalized") : Then %Q(I should not see "Get personalized")
